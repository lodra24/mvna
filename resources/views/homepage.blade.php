    ...
    <footer class="bg-slate-800 text-slate-400">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
            ...
            <nav class="flex flex-wrap justify-center space-x-6 mb-4">
                <a href="#features" class="text-sm hover:text-slate-200">Features</a>
                <a href="#pricing" class="text-sm hover:text-slate-200">Pricing</a>
                <a href="#faq" class="text-sm hover:text-slate-200">FAQ</a>
                <a href="/privacy-policy" class="text-sm hover:text-slate-200">Privacy Policy</a>
                <a href="/terms-of-service" class="text-sm hover:text-slate-200">Terms of Service</a>
            </nav>
