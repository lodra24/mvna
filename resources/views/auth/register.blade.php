            ...
            <div class="text-center">
                ...
                <div class="flex justify-center mb-6">
                    <a href="/" class="flex items-center space-x-3 group">
                        ...
                        <span class="text-2xl font-bold text-slate-800 group-hover:text-mindmetrics-indigo transition-colors duration-200">CognifyWork</span>
                    </a>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-slate-600">
                        Join thousands of professionals discovering their personality insights
                    </p>
                </div>
            </div>
                ...
                <div class="px-8 py-4 bg-gradient-to-r from-mindmetrics-indigo/5 to-mindmetrics-green/5 border-t border-slate-200/50">
                    <div class="text-center text-xs text-slate-500 space-y-1">
                        <p class="flex items-center justify-center">
                            ...
                            Secure registration • GDPR compliant
                        </p>
                    </div>
                </div>
            </div>
